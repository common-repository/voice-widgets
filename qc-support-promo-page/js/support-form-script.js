	...
	jQuery(document).ready(function($){
		...
		$( window ).on( "load", function() {
			...
			var data = {
				...
				'security': qc_voice_widgets_ajax_nonce
			};

	        jQuery.post(qc_voice_widgets_ajaxurl, data, function (response) {

	           	$('.qc_voice_widgets_support').find('.qcld-plugins-lists').html(response);
